...
def detect(save_img=False):
    #####################################################
    my_path = r'../detect_data'
    if not os.path.isdir(my_path):
        os.makedirs(os.path.join(my_path,'image'))
        os.makedirs(os.path.join(my_path,'label'))
    else:
        print('error : There is the same dir name [detect_data]!')
        exit()
    #####################################################
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img or True:  # Add bbox to image
                        ...
                        cache_line = []
                        origin_label_path = r'../pokemon_pattern/label'
